...
<body>
    ...
    <!-- Page Header -->
    <header class="facilities-page-header services-header">
        <div class="container">
            <h1>School Services</h1>
            <p>Essential services supporting student wellbeing, convenience, and overall development</p>
