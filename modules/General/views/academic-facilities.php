...
<body>
    ...
    <!-- Page Header -->
    <header class="facilities-page-header academic-header">
        <div class="container">
            <h1>Academic Facilities</h1>
            <p>State-of-the-art learning environments that foster innovation and academic excellence</p>
        ...
        <div class="facilities-container">
            ...
            <div class="facilities-tabs-nav" id="facilitiesTabsNav">
                <div class="tabs-loading">
                    ...
                    <p>Loading academic facilities...</p>
                </div>
            </div>
